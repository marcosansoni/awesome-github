...
export default function Index() {
  return (
    ...
    //   </div>
    // </main>
    // <div className="bg-white flex h-full flex-col items-center justify-center font-serif text-3xl">
    //   <div>awesome GitHub</div>
    //   <div className="pt-4 font-sans text-lg text-blue-100 sm:pt-8">
